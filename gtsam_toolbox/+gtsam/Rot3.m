...
classdef Rot3 < gtsam.Value
  ...
  methods
    function obj = Rot3(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(152, varargin{2});
        end
        base_ptr = gtsam_wrapper(151, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(153);
      elseif nargin == 1 && isa(varargin{1},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(154, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(155, obj.ptr_gtsamRot3);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(165, this, varargin{:});
      else
