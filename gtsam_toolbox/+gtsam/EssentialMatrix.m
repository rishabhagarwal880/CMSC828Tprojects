...
classdef EssentialMatrix < gtsam.Value
  ...
  methods
    function obj = EssentialMatrix(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(274, varargin{2});
        end
        base_ptr = gtsam_wrapper(273, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'gtsam.Rot3') && isa(varargin{2},'gtsam.Unit3')
        [ my_ptr, base_ptr ] = gtsam_wrapper(275, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(276, obj.ptr_gtsamEssentialMatrix);
    end
    ...
    function varargout = matrix(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(282, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(283, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = Dim(varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(286, varargin{:});
      else
