...
classdef Pose3 < gtsam.Value
  ...
  methods
    function obj = Pose3(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(226, varargin{2});
        end
        base_ptr = gtsam_wrapper(225, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(227);
      ...
      elseif nargin == 2 && isa(varargin{1},'gtsam.Rot3') && isa(varargin{2},'gtsam.Point3')
        [ my_ptr, base_ptr ] = gtsam_wrapper(229, varargin{1}, varargin{2});
      elseif nargin == 1 && isa(varargin{1},'gtsam.Pose2')
        [ my_ptr, base_ptr ] = gtsam_wrapper(230, varargin{1});
      elseif nargin == 1 && isa(varargin{1},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(231, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(232, obj.ptr_gtsamPose3);
    end
    ...
    function varargout = inverse(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(239, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(242, this, varargin{:});
      else
  ...
  methods(Static = true)
    ...
    function varargout = Logmap(varargin)
      ...
      % LOGMAP(Pose3 p)
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Pose3')
        varargout{1} = gtsam_wrapper(257, varargin{:});
      else
    ...
    function varargout = Identity(varargin)
      ...
      % IDENTITY()
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(258, varargin{:});
      else
    ...
    function varargout = Wedge(varargin)
      ...
      if length(varargin) == 6 && isa(varargin{1},'double') && isa(varargin{2},'double') && isa(varargin{3},'double') && isa(varargin{4},'double') && isa(varargin{5},'double') && isa(varargin{6},'double')
        varargout{1} = gtsam_wrapper(259, varargin{:});
      else
