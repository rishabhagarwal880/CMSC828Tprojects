  ...
  methods
    function obj = SymbolicBayesTree(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(505, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(506);
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicBayesTree')
        my_ptr = gtsam_wrapper(507, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(508, obj.ptr_gtsamSymbolicBayesTree);
    end
    ...
    function varargout = clear(this, varargin)
      ...
      gtsam_wrapper(509, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(516, this, varargin{:});
      else
    ...
    function varargout = saveGraph(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(517, this, varargin{:});
      else
