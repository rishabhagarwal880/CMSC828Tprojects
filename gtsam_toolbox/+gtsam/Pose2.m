...
classdef Pose2 < gtsam.Value
  ...
  methods
    function obj = Pose2(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(192, varargin{2});
        end
        base_ptr = gtsam_wrapper(191, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(193);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Pose2')
        [ my_ptr, base_ptr ] = gtsam_wrapper(194, varargin{1});
      elseif nargin == 3 && isa(varargin{1},'double') && isa(varargin{2},'double') && isa(varargin{3},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(195, varargin{1}, varargin{2}, varargin{3});
      elseif nargin == 2 && isa(varargin{1},'double') && isa(varargin{2},'gtsam.Point2')
        [ my_ptr, base_ptr ] = gtsam_wrapper(196, varargin{1}, varargin{2});
      elseif nargin == 2 && isa(varargin{1},'gtsam.Rot2') && isa(varargin{2},'gtsam.Point2')
        [ my_ptr, base_ptr ] = gtsam_wrapper(197, varargin{1}, varargin{2});
      elseif nargin == 1 && isa(varargin{1},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(198, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(199, obj.ptr_gtsamPose2);
    end
    ...
    function varargout = inverse(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(207, this, varargin{:});
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(210, this, varargin{:});
      else
