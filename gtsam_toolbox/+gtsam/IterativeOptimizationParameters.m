...
classdef IterativeOptimizationParameters < handle
  ...
  methods
    function obj = IterativeOptimizationParameters(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(871, varargin{2});
        end
        gtsam_wrapper(870, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_wrapper(872, obj.ptr_gtsamIterativeOptimizationParameters);
    end
    ...
    function varargout = print(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(874, this, varargin{:});
    end
