...
classdef NonlinearEqualityCal3_S2 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = NonlinearEqualityCal3_S2(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1860, varargin{2});
        end
        base_ptr = gtsam_wrapper(1859, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.Cal3_S2')
        [ my_ptr, base_ptr ] = gtsam_wrapper(1861, varargin{1}, varargin{2});
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.Cal3_S2') && isa(varargin{3},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(1862, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1863, obj.ptr_gtsamNonlinearEqualityCal3_S2);
    end
