...
classdef NonlinearOptimizerParams < handle
  ...
  methods
    function obj = NonlinearOptimizerParams(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1099, varargin{2});
        end
        gtsam_wrapper(1098, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1100);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1101, obj.ptr_gtsamNonlinearOptimizerParams);
    end
    ...
    function varargout = isMultifrontal(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(1110, this, varargin{:});
    end
    ...
    function varargout = setMaxIterations(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(1117, this, varargin{:});
    end
    ...
    function varargout = setOrdering(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Ordering')
        gtsam_wrapper(1118, this, varargin{:});
      else
    ...
    function varargout = setRelativeErrorTol(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      gtsam_wrapper(1119, this, varargin{:});
    end
    ...
    function varargout = setVerbosity(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1120, this, varargin{:});
      else
