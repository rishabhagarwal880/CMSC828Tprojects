  ...
  methods
    function obj = SymbolicFactorGraph(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(444, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(445);
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicBayesNet')
        my_ptr = gtsam_wrapper(446, varargin{1});
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicBayesTree')
        my_ptr = gtsam_wrapper(447, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(448, obj.ptr_gtsamSymbolicFactorGraph);
    end
    ...
    function varargout = eliminatePartialMultifrontal(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Ordering')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(451, this, varargin{:});
      elseif length(varargin) == 1 && isa(varargin{1},'gtsam.KeyVector')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(452, this, varargin{:});
      else
    ...
    function varargout = eliminatePartialSequential(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Ordering')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(453, this, varargin{:});
      elseif length(varargin) == 1 && isa(varargin{1},'gtsam.KeyVector')
        [ varargout{1} varargout{2} ] = gtsam_wrapper(454, this, varargin{:});
      else
    ...
    function varargout = keys(this, varargin)
      ...
      % Doxygen can be found at http://research.cc.gatech.edu/borg/sites/edu.borg/html/index.html
      varargout{1} = gtsam_wrapper(459, this, varargin{:});
    end
    ...
    function varargout = marginal(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.KeyVector')
        varargout{1} = gtsam_wrapper(460, this, varargin{:});
      else
    ...
    function varargout = marginalMultifrontalBayesNet(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.Ordering')
        varargout{1} = gtsam_wrapper(461, this, varargin{:});
      elseif length(varargin) == 1 && isa(varargin{1},'gtsam.KeyVector')
        varargout{1} = gtsam_wrapper(462, this, varargin{:});
      elseif length(varargin) == 2 && isa(varargin{1},'gtsam.Ordering') && isa(varargin{2},'gtsam.Ordering')
        varargout{1} = gtsam_wrapper(463, this, varargin{:});
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(465, this, varargin{:});
      else
    ...
    function varargout = push_back(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.SymbolicFactor')
        gtsam_wrapper(466, this, varargin{:});
    ...
    function varargout = push_factor(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'numeric')
        gtsam_wrapper(471, this, varargin{:});
